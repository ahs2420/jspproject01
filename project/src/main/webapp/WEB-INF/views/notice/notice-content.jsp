...
<!-- 추가 css,js -->
<link rel="stylesheet" href="/xkfqkfjs/notice-content.css">
<link rel="stylesheet" href="/xkfqkfjs/reset.css">
</head>
<body>
	<main>
		<div class="notice-content-container">
			<div class="notice-content-title">
				<h2>리워드 서비스 펀딩금 반환정책 시행 공지</h2>
				<br>
				<div class="notice-content-flex-box">
					<img src="/xkfqkfimages/wa.png" alt="" class="notice-content-img">
					<div>
						<p>와디즈</p>
						<p>2020.01.17</p>
					</div>
			...
			<div>
				<div class="inner-contents">
					<p>안녕하세요? 와디즈입니다.</p>
					<br>
					<p>와디즈는 2020년을 맞이하여 서포터 회원님들이 더욱 신뢰하며 서비스를 이용하실 수 있도록 펀딩금 반환
						정책을 준비하였고, 그 시작점으로 지난 11,12월 사이트 공지사항 및 언론보도를 통해 2020년 3월부터 시행하기로
						약속드렸던 리워드 펀딩서비스 관련 펀딩금 반환정책을 오늘 (17일)부터 시행합니다.</p>
					<p>
						<strong>※ 2019.12.18일자 언론보도 &gt;</strong> <a
							href="https://www.hankyung.com/it/article/201912185266j"
							rel="noopener noreferrer" target="_blank">“와디즈, 내년 3월부터 ‘펀딩금
							반환정책’ 시행”</a>&nbsp; (출처 : 한국경제)
					</p>
					<p>
						<br>
					...
					<h3>
						<strong>2. 펀딩금 반환정책 대상</strong>
					</h3>
					<p>1) 1월 17일 (금) 기준 와디즈에서 진행중 (프로젝트가 종료되지 않은)인 프로젝트 및 앞으로 신규
						오픈되는 프로젝트 전체</p>
					<p>2) 1월 17일 (금) 이전 펀딩기간이 종료된 프로젝트는 와디즈 펀딩금 반환정책 대상에 해당하지 않으며,
						각 프로젝트 별로 펀딩안내 페이지의 교환/환불/AS 정책에 따라 펀딩금 반환을 진행할 수 있습니다.</p>
					<p>
						<br>
					</p>
					<h3>
						<strong>3. 펀딩금 반환기준</strong>
					</h3>
					<p>
						<strong>1) 배송 지연 시 반환 기준</strong><br>메이커가 약속한 리워드 발송 시작일보다
						90일 이상 지연된 경우, 서포터는 펀딩금 반환 신청 가능
					</p>
					<p>
						<strong>2) 제품 하자 시 반환 기준</strong><br>- 리워드 제품 수령일로부터 7일 이내
						펀딩금 반환 신청 가능<br>- 아래 상세 운영정책 기준에 근거하여 하자로 인정될 경우 신청 가능<br>-
						크라우드펀딩 특성상, 펀딩 종료 후 단순 변심에 의한 신청은 불가
					</p>
					<p>
					...
					<h3>4. 펀딩금 반환 신청 방법 및 절차</h3>
					<p>1) 오늘 (2020. 01. 17)부터 펀딩금 반환 신청을 하실 수 있으며, 아래 펀딩금 반환 신청
						문의처나 와디즈 고객센터를 통해 절차를 진행하실 수 있습니다. 문의사항에 대해서는 친절히 답변드리겠습니다.</p>
					<p>
						<strong>▶ 펀딩금 반환 신청 문의</strong> &gt; <a
					...
					<p>2) 기존에는 서포터가 펀딩금 반환을 메이커에게 직접 요청했으나, 앞으로는 모든 펀딩금 반환요청 접수는
						와디즈를 통해 진행하고, 펀딩금 반환이 결정된 경우 와디즈가 카드 결제 취소 방식으로 펀딩금이 반환됩니다.</p>
					<p>3) 시스템 적용 이전에 시행하다보니 펀딩금 반환 접수 후 응대, 처리까지 시간이 다소 소요될 수 있음을
						다시한번 양해 부탁드립니다.</p>
					<p>&nbsp;</p>
					<p>
						더욱 신뢰할 수 있는 와디즈가 되기 위해 노력하겠습니다.<br>감사합니다.
					</p>
					<p>와디즈 드림&nbsp;</p>
				</div>
			</div>
