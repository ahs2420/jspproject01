    ...
    <div class="basic-box">
        ...
        <div class="ba-project">
            ...
            <div class="flex-basic2 ">
                <div class="mar-bo3 wid4 ">
                    ...
                    <p class="fon-siz3 fon-col fon-wei mar-bo6">법인사업자는 법인등기부상 법인명 / 개인 사업자는 주민등록상 성명 또는 상호 /
                        개인은
                        주민등록상 성명을 입력하세요. </p>
                    <input class="wid1 hei1 fon-bor1 text-padding1" type="text" id="text-box1" placeholder="메이커명 입력">
            ...
            <div class="flex-basic2 ba-pro-name">
                <div class="mar-bo2 wid4">
                    <label for="projectimg" class="di-la1 mar-top1 fon-wei1">메이커 프로필 이미지<span class="fon-co5">
                            *</span></label><br>
            ...
            <div class="repre-container">
                ...
                <div class="flex-basic2 ba-pro-name">
                    <div class="mar-bo2 wid4 ">
                        <label for="projectprice" class="di-la1 mar-top1 fon-wei1">사업자 구분<span class="fon-co5">
                                *</span></label>
                ...
                <div class="flex-basic2 ">
                    <div class="mar-bo2 wid4 ">
                        <label for="projectprice" class="di-la1 mar-top1 fon-wei1">대표자 이메일<span class="fon-co5">
                                *</span></label>
                        ...
                        <div class="mar-bo2 wid4 ">
                            ...
                            <div class="flex-end">
                                <input class="wid6 hei1 fon-bor1 text-padding1" type="text" id="projectprice"
                                    placeholder="공통 대표자 입력">
                                <input class="wid10 hei1 fon-bor1 text-padding1" type="text" id="projectprice"
                                    placeholder="공통 대표자 이메일 입력">
                                <span class="add-btn ">
                                    <button
