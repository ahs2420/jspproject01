...
<link rel="stylesheet" href="../hongcss/mypage/mypage-two.css">
<!-- fontawesome 코드 -->
    ...
    <div class="mypage-container" style="max-width: 100%;">
        ...
        <div class="box2-funReady">
            ...
            <div class="ba-project">
                ...
                <!-- 2번 -->
                <div class="flex-basic1 ba-pro-name">
                ...
                <div class="flex-basic2 q4-ck-si ba-pro-name">
                    <div class="mar-bo2 wid4">
                        <div class="name-left">
                            <div class="box-text-one">
                                <h4>프로젝트 요약<span class="fon-co5">
                        ...
                        <div class="name-left">
                            <div class="box-text-one">
                                <h4>프로젝트 스토리<span class="fon-co5">
                                        *</span></h4>
                                <p class="fon-col fon-siz3 mar-bo4">진정성 있고 매력적인 스토리로 서포터의 마음을 움직여볼까요? 우측의 스토리 필수 항목을
                                    꼼꼼하게 확인
