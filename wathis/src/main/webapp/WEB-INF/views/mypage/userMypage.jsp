...
<!-- hero 삽입 -->
    ...
    <div class="sub-nav">
        <ul class="sub-menu flex-box flex-j-center flex-wrap">
            ...
            <li class="w-33p bold <c:if test="${template eq 'makeList'}">on</c:if>"><a class="sub-view-btn" type="button" href="/page/userMypage?template=makeList" ><span class="dis-pc">제작한프로젝트</span><span class="dis-mobile">제작</span></a></li>
