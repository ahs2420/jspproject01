<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <section>
        <div class="container max600" id="term-box">
            <form name="baseInfoForm" action="/login/findID" enctype="multipart/form-data">
                <div class="pb20  border-bottom">
                    <h1 class="large-title bold">아이디 찾기</h1>
                </div>
                <div class="mt50">
                    <p class="bold mb5">이름</p>
                    <input type="text" name="uname" class="input-stan w-100p" />
                </div>
                <div class="mt20">
