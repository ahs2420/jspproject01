...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 ...
 <div class="main-board br-3 bg-color-8 margin-t20 padding-a-20">
     ...
     <div id="board-view" class="board-view margin-t30">
         <form action="/menu/setMenuModify" method="POST" class="chkForm">
            ...
            <tr class="tr-45">
                ...
                <td class="w-85 padding-lr-5" colspan="3">
                    ...
                    <input type="text" name="title" class="input-200 padding-lr-5 chkitem" data-error="메뉴이름을" value="${mvo.title}">
            ...
            <tr class="tr-45">
                ...
                <td class="w-35 padding-lr-5">
                    <input type="text" name="url" class="input-200 padding-lr-5 chkItem" data-error="메뉴 URL을" value="${mvo.url}">
                </td>
                <td class="bg-color-10 w-15 f6 align">메뉴 출력 순서</td>
                <td class="w-35 padding-lr-5">
                    <input type="text" name="morder" class="input-200 padding-lr-5 chkitem" value="${mvo.morder}" data-error="메뉴 출력 순서를">
                </td>
            </tr>
            <tr>
                <td class="tbl-line" colspan="4"></td>
        ...
        <div class="btn-grp margin-t20">
            ...
            <div class="btn-left float-r">
                <button type="submit" class="btn-80 bold bo-blue">메뉴 수정</button>
