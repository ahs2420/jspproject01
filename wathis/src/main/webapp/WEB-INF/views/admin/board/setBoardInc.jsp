     ...
     <div id="board-view" class="board-view margin-t30">
         <form action="/board/setBoard" method="POST" class="chkForm">
            ...
            <tr class="tr-45">
                ...
                <td class="w-35 padding-lr-5">
                    <input type="text" name="boardCode" class="input-200 padding-lr-5 chkItem" data-error="게시판 코드를">
                    <span id="confirm" class="font-14 bold orange"></span>
                </td>
                <td class="bg-color-10 w-15 f6 align">게시판 이름</td>
                <td class="w-35 padding-lr-5">
                    <input type="text" name="boardName" class="input-200 padding-lr-5 chkItem" data-error="게시판 이름을">
                </td>
            </tr>
            <tr>
                <td class="tbl-line" colspan="4"></td>
            ...
            <tr class="tr-45">
                ...
                <td class="w-85 padding-lr-5" colspan=3>
                    ...
                    <span id="clrBox" class="clrBox valign margin-l10"></span>
                </td>
                <!-- 
                <td class="bg-color-10 w-15 f6 align">게시판 생성자</td>
                <td class="w-35 padding-lr-5">
                    <input type="text" name="boardMaker" class="input-200 padding-lr-5 chkItem" value="${sessionScope.userID}" readonly data-error="게시판 생성자">
                </td>
                 -->
            </tr>
            <tr>
        ...
        <div class="btn-grp margin-t20">
            ...
            <div class="btn-left float-r">
                <button type="submit" class="btn-80 bold bo-blue">게시판 생성</button>
