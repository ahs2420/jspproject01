     ...
     <div id="board-view" class="board-view margin-t30">
         ...
         <table>
            ...
            <tr class="tr-45">
                ...
                <td class="w-35 padding-lr-5">${bvo.boardName}</td>
            </tr>
            <tr>
                <td class="tbl-line" colspan="4"></td>
            </tr>
            <tr class="tr-45">
                ...
                <td class="w-85 padding-lr-5" colspan="3">
                    <!-- <select class="sel-180 valign" id="boardColor" name="boardColor">
                        <option value="">선택</option>
                        <c:forTokens items="#5D1049,#B00020,#1A237E,#2962FF" delims="," var="item">
                            <option value="${item}">${item}</option>
                        </c:forTokens>
                    </select> -->
                    <span id="clrBox" class="clrBox valign" style="background-color: ${bvo.boardColor};"></span>
                    ${bvo.boardColor}
                </td>
            </tr>
            <tr>
